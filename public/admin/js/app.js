...
__webpack_require__(/*! ./pages/advertising/index_advertising */ "./resources/assets/js/admin/pages/advertising/index_advertising.js");

__webpack_require__(/*! ./pages/advertising/create_update_advertising */ "./resources/assets/js/admin/pages/advertising/create_update_advertising.js");
/**
...
/***/ "./resources/assets/js/admin/helpers/helpers.js":
/*!******************************************************!*\
  !*** ./resources/assets/js/admin/helpers/helpers.js ***!
  \******************************************************/
...
function slugify(string) {
  ...
  string = string.replace(/[^\w ]+/g, '').replace(/ +/gi, "-").replace(/\-\-\-\-\-/gi, '-').replace(/\-\-\-\-/gi, '-').replace(/\-\-\-/gi, '-').replace(/\-\-/gi, '-'); //Xóa các ký tự gạch ngang ở đầu và cuối
...
/***/ "./resources/assets/js/admin/pages/advertising/create_update_advertising.js":
/*!**********************************************************************************!*\
  !*** ./resources/assets/js/admin/pages/advertising/create_update_advertising.js ***!
  \**********************************************************************************/
/*! no exports provided */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _utilities_images_image__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../utilities/images/image */ "./resources/assets/js/admin/utilities/images/image.js");
...
/***/ "./resources/assets/js/admin/pages/advertising/index_advertising.js":
/*!**************************************************************************!*\
  !*** ./resources/assets/js/admin/pages/advertising/index_advertising.js ***!
  \**************************************************************************/
/*! no exports provided */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _helpers_helpers__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../helpers/helpers */ "./resources/assets/js/admin/helpers/helpers.js");
...
/***/ "./resources/assets/js/admin/utilities/images/image.js":
/*!*************************************************************!*\
  !*** ./resources/assets/js/admin/utilities/images/image.js ***!
  \*************************************************************/
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initInputImage", function() { return initInputImage; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initInputMultiImage", function() { return initInputMultiImage; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "newInputImage", function() { return newInputImage; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "newInputMultiImage", function() { return newInputMultiImage; });
...
function newInputImage(inputImage) {
  var maxSize = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 1024;
...
function initInputImage(oldImage, newInputImage, urlDelete) {
  ...
  oldImageValue = $(oldImage).val(); // get image url.
...
function initInputMultiImage(oldImage, newInputImage, urlDelete) {
  var option = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : {};
  var imgName,
      imgObject,
      oldImageValue,
      imgPreview = [],
      imgPreviewConfig = []; // check input length.
  ...
  if (oldImageValue !== undefined && oldImageValue !== '') {
    ...
    $.each(oldImageValue.split('|'), function (index, img) {
      ...
      if (imgObject.length) {
        ...
        imgPreview.push(imgObject[0]); // get image name.

        imgName = imgObject[0].replace(/^.*[\\\/]/, ''); // set image config.

        imgPreviewConfig.push({
          caption: imgName,
          width: "120px",
          downloadUrl: false,
          key: imgObject[1]
...
/***/ 0:
/*!************************************************!*\
  !*** multi ./resources/assets/js/admin/app.js ***!
  \************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! D:\www\ba_news\resources\assets\js\admin\app.js */"./resources/assets/js/admin/app.js");
