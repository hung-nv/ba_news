...
@section('content')
    <div class="page-content-wrapper">
        <div class="page-content">
            ...
            <h3 class="page-title"> Managed Category</h3>
                        ...
                        <div class="portlet-body">
                            <div class="table-toolbar">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="btn-group">
                                            <a class="btn sbold blue" href="{{ route('category.create') }}"> Add New
                            ...
                            <table class="table table-striped table-bordered table-hover table-checkable order-column"
                                ...
                                <tbody>
                                    <?php setMultiCategoryLevel($category); ?>
                                </tbody>
                            </table>
                        </div>
                    </div>
...
@section('footer')
    ...
    <script>
        $(function () {
            pageDatatable('#data-category');
            confirmBeforeDelete('#data-category', 'If you delete, all child category has been deleted');
        });
    </script>
@endsection